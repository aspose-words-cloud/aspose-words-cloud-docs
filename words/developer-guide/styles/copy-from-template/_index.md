...
### How to copy a style from template using cURL or Postman
...
### How to copy a style from template using Python, Java, C#, C++, JavaScript and other programming languages
