...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/styles/copy](https://api.aspose.cloud/v4.0/words/online/post/styles/copy) | PUT |
...
### How to Copy a style from an element in a Word document using cURL or Postman
...
### How to Copy a style from an element in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
