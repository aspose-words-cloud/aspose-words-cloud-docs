...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | /words/online/get/styles/{styleName} | PUT         |
...
### How to Reads a style from the document using cURL or Postman
...
### How to Reads a style from the document using Python, Java, C#, C++, JavaScript and other programming languages
