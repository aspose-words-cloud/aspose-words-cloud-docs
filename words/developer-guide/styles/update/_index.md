...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/styles/{styleName}/update](https://api.aspose.cloud/v4.0/words/online/put/styles/{styleName}/update) | PUT |
...
### How to Update a style of a document element in a Word document using cURL or Postman
...
### How to Update a style of a document element in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
