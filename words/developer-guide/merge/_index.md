...
You can use **cURL** and **Postman** to access Aspose.Words Cloud API. The following examples demonstate how to do it. Please refer to the <a href="/words/getting-started/quickstart/">instructions</a> to get a 'JWT_TOKEN' for authorization. Feel free to download and explore sample input [test_doc.docx](test_doc.docx), [test_multi_pages.docx](test_multi_pages.docx) and output [test_doc_output.docx](test_doc_output.docx) file designed to act as a demonstration and let you figure out the details quickly.
