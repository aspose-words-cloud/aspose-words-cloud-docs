...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/appendDocument](https://api.aspose.cloud/v4.0/words/online/put/appendDocument) | PUT |
...
### How to Merge Word documents. Merge DOCX, PDF, RTF into one with a single request using cURL or Postman
...
### How to Merge Word documents. Merge DOCX, PDF, RTF into one with a single request using Python, Java, C#, C++, JavaScript and other programming languages
