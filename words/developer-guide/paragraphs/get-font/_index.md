...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{paragraphPath}/runs/{index}/font](https://api.aspose.cloud/v4.0/words/online/get/{paragraphPath}/runs/{index}/font) | PUT |
...
### How to Get a font of a run, contained within a paragraph, in a Word document using cURL or Postman
...
### How to Get a font of a run, contained within a paragraph, in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
