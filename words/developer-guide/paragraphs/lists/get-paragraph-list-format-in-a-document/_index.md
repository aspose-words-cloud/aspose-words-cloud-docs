...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/paragraphs/{index}/listFormat](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/paragraphs/{index}/listFormat) | PUT |
...
### How to Get paragraph's list formatting in a Word document using cURL or Postman
...
### How to Get paragraph's list formatting in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
