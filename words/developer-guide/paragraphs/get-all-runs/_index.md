...
## Get all runs from paragraph in Word online REST API
...
## Get all runs from paragraph in Word online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to get all runs from paragraph in Word online with cURL or Postman
...
### How to get all runs from paragraph in Word online in Python, Java, C#, C++, JavaScript and other programming languages
