...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{paragraphPath}/runs](https://api.aspose.cloud/v4.0/words/online/get/{paragraphPath}/runs) | PUT |
...
### How to Get all runs from a paragraph in a Word document using cURL or Postman
...
### How to Get all runs from a paragraph in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
