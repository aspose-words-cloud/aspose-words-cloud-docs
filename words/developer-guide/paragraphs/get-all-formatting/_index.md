...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/paragraphs/{index}/format](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/paragraphs/{index}/format) | PUT |
...
### How to Get all formatting for a paragraphs in a Word document using cURL or Postman
...
### How to Get all formatting for a paragraphs in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
