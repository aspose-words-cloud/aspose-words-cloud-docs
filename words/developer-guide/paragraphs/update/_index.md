...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/{nodePath}/paragraphs/{index}/format](https://api.aspose.cloud/v4.0/words/online/put/{nodePath}/paragraphs/{index}/format) | PUT |
...
### How to Update paragraph formatting properties in a Word document using cURL or Postman
...
### How to Update paragraph formatting properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
