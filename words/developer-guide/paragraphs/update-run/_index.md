...
## Update Run properties in document online REST API
...
| `run`                | RunUpdate | Required           | Run data.                                                    |
...
## Update Run properties in document online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to update Run properties in document online with cURL or Postman
...
### How to update Run properties in document online in Python, Java, C#, C++, JavaScript and other programming languages
