...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{nodePath}/paragraphs/{index}/tabstops](https://api.aspose.cloud/v4.0/words/online/delete/{nodePath}/paragraphs/{index}/tabstops) | PUT |
...
### How to Delete all paragraph's tab stops from a Word document using cURL or Postman
...
### How to Delete all paragraph's tab stops from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
