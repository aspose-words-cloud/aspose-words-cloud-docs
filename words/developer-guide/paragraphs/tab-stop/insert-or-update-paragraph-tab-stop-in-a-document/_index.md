...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/{nodePath}/paragraphs/{index}/tabstops](https://api.aspose.cloud/v4.0/words/online/post/{nodePath}/paragraphs/{index}/tabstops) | PUT |
...
### How to Insert or update a paragraph's tab stop in a Word document using cURL or Postman
...
### How to Insert or update a paragraph's tab stop in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
