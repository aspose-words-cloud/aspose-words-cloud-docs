...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/{paragraphPath}/runs](https://api.aspose.cloud/v4.0/words/online/post/{paragraphPath}/runs) | PUT |
...
| `insertBeforeNode`   | string | The index of the node. A new Run object will be inserted before the node with the specified node Id. |
...
### How to Add a run to a paragraph in a Word document using cURL or Postman
...
### How to Add a run to a paragraph in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
