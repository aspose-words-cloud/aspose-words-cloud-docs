...
## Compare Word documents online REST API
...
| `compareData`        | CompareData | Required           | Compare data.                                                |
| `comparingDocument`  | string(binary) | Optional           | The comparing document.                                      |
...
## Compare Word documents online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to compare Word documents online with cURL or Postman
...
### How to compare Word documents online in Python, Java, C#, C++, JavaScript and other programming languages
