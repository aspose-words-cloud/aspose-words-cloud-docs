...
You can carry out REST API interactions using **cURL** and **Postman**. Please read these <a href="/words/getting-started/quickstart/">instructions</a> to receive a personal `JWT_TOKEN` for authorization. Download sample [test_multi_pages.docx](test_multi_pages.docx) file designed to act as a demonstration and let you figure out the details quickly.
