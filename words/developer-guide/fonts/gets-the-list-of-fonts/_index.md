...
### How to get a list of fonts from a Word document using cURL or Postman
...
### How to get a list of fonts from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
