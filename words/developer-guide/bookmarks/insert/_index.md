...
## Insert bookmark to Word online REST API
...
| `bookmark`           | BookmarkInsert | Required           | Bookmark to insert.                                          |
...
## Insert bookmark to Word online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to insert bookmark to Word online with cURL or Postman
...
### How to insert bookmark to Word online in Python, Java, C#, C++, JavaScript and other programming languages
