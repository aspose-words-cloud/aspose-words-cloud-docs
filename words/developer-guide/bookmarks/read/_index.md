...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/bookmarks/{bookmarkName}](https://api.aspose.cloud/v4.0/words/online/get/bookmarks/{bookmarkName}) | PUT |
...
### How to Read a bookmark in a Word document using cURL or Postman
...
{{< tab tabNum="1" >}}
{{< gist "aspose-words-cloud-gists" "8a52e648cd36d3e0a7402727561073b6" "GetBookmarkByNameOnline.curl" >}}
...
{{< /tab >}}
{{< tab tabNum="2" >}}
{{< gist "aspose-words-cloud-gists" "894866974db18d27af2a7f67dd929b6f" "GetBookmarkByNameOnline.json" >}}
...
### How to Read a bookmark in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
