...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/bookmarks](https://api.aspose.cloud/v4.0/words/online/get/bookmarks) | PUT |
...
### How to Get bookmarks in a Word document using cURL or Postman
...
### How to Get bookmarks in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
