...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/comments/{commentIndex}](https://api.aspose.cloud/v4.0/words/online/delete/comments/{commentIndex}) | PUT |

, where:

* `commentIndex` - the index of the comment.
...
### How to Delete a comment from a Word document using cURL or Postman
...
### How to Delete a comment from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
