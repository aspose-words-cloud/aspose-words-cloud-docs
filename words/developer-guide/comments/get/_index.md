...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/comments/{commentIndex}](https://api.aspose.cloud/v4.0/words/online/get/comments/{commentIndex}) | PUT |
...
### How to Get a comment from a Word document using cURL or Postman
...
### How to Get a comment from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
