...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/comments](https://api.aspose.cloud/v4.0/words/online/post/comments) | PUT |
...
### How to Add a comment to a Word document using cURL or Postman
...
### How to Add a comment to a Word document using Python, Java, C#, C++, JavaScript and other programming languages
