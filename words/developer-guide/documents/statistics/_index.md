...
## Get statistical information from Word online REST API
...
| `includeComments`    | boolean   | Optional           | The flag indicating whether to include comments from the WordCount. The default value is "false". |
| `includeFootnotes`   | boolean   | Optional           | The flag indicating whether to include footnotes from the WordCount. The default value is "false". |
| `includeTextInShapes` | boolean   | Optional           | The flag indicating whether to include shape's text from the WordCount. The default value is "false". |
...
## Get statistical information from Word online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to get statistical information from Word online with cURL or Postman
...
### How to get statistical information from Word online in Python, Java, C#, C++, JavaScript and other programming languages
