...
## Create new word document online REST API
...
| `folder`             | string    | Optional           | The path to the document folder.                             |
...
## Create new word document online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to create new word document online with cURL or Postman
...
### How to create new word document online in Python, Java, C#, C++, JavaScript and other programming languages
