...
### How to create a new word document using cURL or Postman
...
### How to create a new word document using Python, Java, C#, C++, JavaScript and other programming languages
