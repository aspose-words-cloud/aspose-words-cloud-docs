...
### How to Render a DrawingObject in image format using cURL or Postman
...
{{< tab tabNum="1" >}}
{{< gist "aspose-words-cloud-gists" "8a52e648cd36d3e0a7402727561073b6" "RenderDrawingObjectOnline.curl" >}}
...
{{< /tab >}}
{{< tab tabNum="2" >}}
{{< gist "aspose-words-cloud-gists" "894866974db18d27af2a7f67dd929b6f" "RenderDrawingObjectOnline.json" >}}
...
### How to Render a DrawingObject in image format using Python, Java, C#, C++, JavaScript and other programming languages
