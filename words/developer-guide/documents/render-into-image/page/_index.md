...
### How to render a page of the document in image format using cURL or Postman
...
### How to render a page of the document in image format using Python, Java, C#, C++, JavaScript and other programming languages
