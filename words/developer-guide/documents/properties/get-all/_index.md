...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/documentProperties](https://api.aspose.cloud/v4.0/words/online/get/documentProperties) | PUT |
...
### How to Get all document properties from a Word document using cURL or Postman
...
### How to Get all document properties from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
