...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/sections/{sectionIndex}](https://api.aspose.cloud/v4.0/words/online/get/sections/{sectionIndex}) | PUT |
...
### How to Get a section from a Word document using cURL or Postman
...
### How to Get a section from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
