...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/sections/{sectionIndex}/pageSetup](https://api.aspose.cloud/v4.0/words/online/put/sections/{sectionIndex}/pageSetup) | PUT |
...
### How to Update page setup properties of a section in a Word document using cURL or Postman
...
### How to Update page setup properties of a section in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
