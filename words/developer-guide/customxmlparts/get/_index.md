...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/customXmlParts/{customXmlPartIndex}](https://api.aspose.cloud/v4.0/words/online/get/customXmlParts/{customXmlPartIndex}) | PUT |
...
### How to Get Custom XML Part in a Word document using cURL or Postman
...
### How to Get Custom XML Part in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
...
{{< /tab >}}
{{< tab tabNum="9" >}}
{{< gist "aspose-words-cloud-gists" "790dbd2edd5d36f170732366f52cac4c" "GetCustomXmlPartOnline.swift" >}}
{{< /tab >}}
{{< tab tabNum="10" >}}
{{< gist "aspose-words-cloud-gists" "6aae628cf2b878b78fea177c3171c6bf" "GetCustomXmlPartOnline.dart" >}}
{{< /tab >}}
{{< /tabs >}}
{{< /nosnippet >}}
