...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/customXmlParts](https://api.aspose.cloud/v4.0/words/online/delete/customXmlParts) | PUT |
...
### How to Delete All Custom XML Parts in a Word document using cURL or Postman
...
### How to Delete All Custom XML Parts in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
