...
description: "Update Custom XML Part in a Word document"
weight: 40
---

Updates the custom xml part in the document.

## Update Custom XML Part in Word document REST API
...
## Update Custom XML Part in Word document usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to update Custom XML Part in Word document with cURL or Postman
...
### How to update Custom XML Part in Word document in Python, Java, C#, C++, JavaScript and other programming languages
