...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/customXmlParts](https://api.aspose.cloud/v4.0/words/online/post/customXmlParts) | PUT |
...
### How to Insert Custom XML Part into a Word document using cURL or Postman
...
### How to Insert Custom XML Part into a Word document using Python, Java, C#, C++, JavaScript and other programming languages
