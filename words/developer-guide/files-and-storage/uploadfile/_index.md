...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | /words1.0/storage/file/{path} | PUT         |
...
### How to Upload a file to Cloud Storage using cURL or Postman
...
### How to Upload a file to Cloud Storage using Python, Java, C#, C++, JavaScript and other programming languages
