...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/tables/{index}](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/tables/{index}) | PUT |
...
### How to Get a table in a Word document using cURL or Postman
...
### How to Get a table in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
