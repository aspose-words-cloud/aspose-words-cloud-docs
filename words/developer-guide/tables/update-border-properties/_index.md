...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/{nodePath}/borders/{borderType}](https://api.aspose.cloud/v4.0/words/online/put/{nodePath}/borders/{borderType}) | PUT |
...
### How to Update table's border properties in a Word document using cURL or Postman
...
### How to Update table's border properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
