...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/{nodePath}/tables/{index}/properties](https://api.aspose.cloud/v4.0/words/online/put/{nodePath}/tables/{index}/properties) | PUT |
...
### How to Update table properties in a Word document using cURL or Postman
...
### How to Update table properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
