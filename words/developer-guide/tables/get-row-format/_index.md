...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{tablePath}/rows/{index}/rowformat](https://api.aspose.cloud/v4.0/words/online/get/{tablePath}/rows/{index}/rowformat) | PUT |
...
### How to Get table's `Row` formatting properties in a Word document using cURL or Postman
...
### How to Get table's `Row` formatting properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
