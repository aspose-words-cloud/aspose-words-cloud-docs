...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{tablePath}/rows/{index}](https://api.aspose.cloud/v4.0/words/online/get/{tablePath}/rows/{index}) | PUT |
...
### How to Get a table's row in a Word document using cURL or Postman
...
### How to Get a table's row in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
