...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{nodePath}/borders](https://api.aspose.cloud/v4.0/words/online/delete/{nodePath}/borders) | PUT |
...
### How to Reset table's border properties to default values using cURL or Postman
...
### How to Reset table's border properties to default values using Python, Java, C#, C++, JavaScript and other programming languages
