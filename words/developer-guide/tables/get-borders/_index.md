...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/borders](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/borders) | PUT |
...
### How to Get a list of table's borders in a Word document using cURL or Postman
...
### How to Get a list of table's borders in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
