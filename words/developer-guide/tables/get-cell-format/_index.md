...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{tableRowPath}/cells/{index}/cellformat](https://api.aspose.cloud/v4.0/words/online/get/{tableRowPath}/cells/{index}/cellformat) | PUT |
...
### How to Get table's cell formatting properties in a Word document using cURL or Postman
...
### How to Get table's cell formatting properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
