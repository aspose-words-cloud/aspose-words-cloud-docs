...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/lists/{listId}/listLevels/{listLevel}](https://api.aspose.cloud/v4.0/words/online/put/lists/{listId}/listLevels/{listLevel}) | PUT |

, where:

* `listId` - the list Id.
* `listLevel` - the list level.
...
### How to Update a list's level in a Word document using cURL or Postman
...
### How to Update a list's level in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
