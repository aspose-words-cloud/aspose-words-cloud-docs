...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/lists/{listId}](https://api.aspose.cloud/v4.0/words/online/put/lists/{listId}) | PUT |
...
### How to Update a list in a Word document using cURL or Postman
...
### How to Update a list in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
