...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/lists](https://api.aspose.cloud/v4.0/words/online/post/lists) | PUT |
...
### How to Insert a list into a Word document using cURL or Postman
...
### How to Insert a list into a Word document using Python, Java, C#, C++, JavaScript and other programming languages
