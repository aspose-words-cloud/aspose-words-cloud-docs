...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/watermarks/texts](https://api.aspose.cloud/v4.0/words/online/post/watermarks/texts) | PUT |
...
### How to Insert a watermark text into a Word document using cURL or Postman
...
### How to Insert a watermark text into a Word document using Python, Java, C#, C++, JavaScript and other programming languages
