...
The [OpenAPI Specification](https://apireference.aspose.cloud/words/#/Watermarks/InsertWatermarkText) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
...
{{< tab tabNum="1" >}}
{{< gist "aspose-words-cloud-gists" "caede439bfd2e57c3010befe504faff4" "PostInsertDocumentWatermarkText.java" >}}
{{< /tab >}}
{{< tab tabNum="2" >}}
{{< gist "aspose-words-cloud-gists" "374e1e3dd4bca8f696f29d913645f549" "InsertWatermarkText.cs" >}}
{{< /tab >}}
{{< tab tabNum="3" >}}
{{< gist "aspose-words-cloud-gists" "625ca80adffd779e8f6e3611551e14d5" "InsertDocumentWatermarkText.go" >}}
{{< /tab >}}
{{< tab tabNum="4" >}}
{{< gist "aspose-words-cloud-gists" "fde11f9e52383a88af20b937c5e9b3d9" "Aspose_Cloud_Words_PostInsertDocumentWatermarkText.java" >}}
{{< /tab >}}
{{< tab tabNum="5" >}}
{{< gist "aspose-words-cloud-gists" "790dbd2edd5d36f170732366f52cac4c" "Aspose_Words_Swift_PostInsertDocumentWatermarkText.swift" >}}
{{< /tab >}}
{{< /tabs >}}
{{< /nosnippet >}}
