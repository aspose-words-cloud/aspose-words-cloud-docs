...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/watermarks/images](https://api.aspose.cloud/v4.0/words/online/post/watermarks/images) | PUT |
...
| `rotationAngle`      | number | The rotation angle of the watermark.                         |
| `image`              | string | The filename of the image. If the parameter value is missing — the image data is expected in the request content. |
