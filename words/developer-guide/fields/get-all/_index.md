...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/fields](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/fields) | PUT |
...
### How to Get all fields from a Word document using cURL or Postman
...
### How to Get all fields from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
