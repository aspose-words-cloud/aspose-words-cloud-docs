...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/{nodePath}/fields/{index}](https://api.aspose.cloud/v4.0/words/online/put/{nodePath}/fields/{index}) | PUT |
...
### How to Update field properties in a document using cURL or Postman
...
### How to Update field properties in a document using Python, Java, C#, C++, JavaScript and other programming languages
