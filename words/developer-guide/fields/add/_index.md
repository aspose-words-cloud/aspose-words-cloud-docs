...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/post/{nodePath}/fields](https://api.aspose.cloud/v4.0/words/online/post/{nodePath}/fields) | PUT |
...
| `insertBeforeNode`   | string | The index of the node. A new field will be inserted before the node with the specified node Id. |
...
### How to Add a field into a Word document using cURL or Postman
...
### How to Add a field into a Word document using Python, Java, C#, C++, JavaScript and other programming languages
