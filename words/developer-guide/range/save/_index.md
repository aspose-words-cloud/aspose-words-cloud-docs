...
The following 'RangeDocument' parameters are used in the request body:

| Property Name        | Data Type   | Description                                                  |
|----------------------|-------------|--------------------------------------------------------------|
| `DocumentName`       | string   | Name for a new document.                                     |
...
### How to Save the selected range as a new document using cURL or Postman
...
### How to Save the selected range as a new document using Python, Java, C#, C++, JavaScript and other programming languages
