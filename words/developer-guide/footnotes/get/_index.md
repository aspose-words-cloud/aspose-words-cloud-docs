...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/footnotes/{index}](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/footnotes/{index}) | PUT |
...
### How to Get a footnote from a Word document using cURL or Postman
...
### How to Get a footnote from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
