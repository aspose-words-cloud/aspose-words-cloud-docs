...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{nodePath}/footnotes/{index}](https://api.aspose.cloud/v4.0/words/online/delete/{nodePath}/footnotes/{index}) | PUT |
...
### How to Remove a footnote from a Word document using cURL or Postman
...
### How to Remove a footnote from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
