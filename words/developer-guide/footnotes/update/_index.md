...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/put/{nodePath}/footnotes/{index}](https://api.aspose.cloud/v4.0/words/online/put/{nodePath}/footnotes/{index}) | PUT |
...
### How to Update footnote properties in a Word document using cURL or Postman
...
### How to Update footnote properties in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
