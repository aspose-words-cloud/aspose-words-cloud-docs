...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/footnotes](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/footnotes) | PUT |
...
### How to Get footnotes from a Word document using cURL or Postman
...
### How to Get footnotes from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
