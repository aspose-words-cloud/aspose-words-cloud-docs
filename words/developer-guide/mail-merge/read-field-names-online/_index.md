...
## Get Mail Merge field names in Word online REST API
...
| `useNonMergeFields`  | boolean   | Optional           | The flag indicating whether to use non merge fields. If true, result includes "mustache" field names. |
...
|----------------------|-----------|--------------------|---------------------------------|
| `template`           | string(binary) | Required           | The template document.                                       |
...
## Get Mail Merge field names in Word online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to get Mail Merge field names in Word online with cURL or Postman
...
### How to get Mail Merge field names in Word online in Python, Java, C#, C++, JavaScript and other programming languages
