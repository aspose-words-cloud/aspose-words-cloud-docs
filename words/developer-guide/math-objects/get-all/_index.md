...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/OfficeMathObjects](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/OfficeMathObjects) | PUT |
...
### How to Get all officemath objects from a Word document using cURL or Postman
...
### How to Get all officemath objects from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
