...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{nodePath}/OfficeMathObjects/{index}](https://api.aspose.cloud/v4.0/words/online/delete/{nodePath}/OfficeMathObjects/{index}) | PUT |
...
### How to Remove an officemath object from a Word document using cURL or Postman
...
### How to Remove an officemath object from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
