...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{nodePath}/drawingObjects/{index}](https://api.aspose.cloud/v4.0/words/online/delete/{nodePath}/drawingObjects/{index}) | PUT |
...
### How to Delete drawing objects from a Word document using cURL or Postman
...
### How to Delete drawing objects from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
