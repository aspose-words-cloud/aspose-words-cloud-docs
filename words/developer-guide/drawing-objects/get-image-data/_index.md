...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/drawingObjects/{index}/imageData](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/drawingObjects/{index}/imageData) | PUT |
...
### How to Get image data from a drawing object in a Word document using cURL or Postman
...
### How to Get image data from a drawing object in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
