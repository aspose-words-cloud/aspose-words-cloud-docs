...
## Add drawing objects into Word online REST API
...
| `multipartbody`      | #/paths//words/{name}/drawingObjects/post/requestBody/content/application/json/schema | Required           |                                                              |
...
## Add drawing objects into Word online usage examples

Let's look at practical examples of using the web service. You can do this both with cURL and Postman utilities, and from your code in various programming languages: Python, Java, JavaScript, C#, PHP, C++, Go, Ruby, Swift, Dart.

### How to add drawing objects into Word online with cURL or Postman
...
### How to add drawing objects into Word online in Python, Java, C#, C++, JavaScript and other programming languages
