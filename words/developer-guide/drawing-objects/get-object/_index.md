...
The following are a few examples of using cURL. You can use a sample **Input Document**: [test_multi_pages.docx](attachments/885442/1180124.docx). The **Output File** would be as follows: [drawingObject.png](attachments/885442/1180123.png).
