...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/formfields](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/formfields) | PUT |
...
### How to Get all form fields from a Word document using cURL or Postman
...
### How to Get all form fields from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
