...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{nodePath}/formfields/{index}](https://api.aspose.cloud/v4.0/words/online/get/{nodePath}/formfields/{index}) | PUT |
...
### How to Get a form field from a paragraph in a Word document using cURL or Postman
...
### How to Get a form field from a paragraph in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
