...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/get/{sectionPath}/headersfooters](https://api.aspose.cloud/v4.0/words/online/get/{sectionPath}/headersfooters) | PUT |
...
| `filterByType`       | string | The list of HeaderFooter types.                              |
...
### How to Get all headers and footers in a Word document using cURL or Postman
...
### How to Get all headers and footers in a Word document using Python, Java, C#, C++, JavaScript and other programming languages
