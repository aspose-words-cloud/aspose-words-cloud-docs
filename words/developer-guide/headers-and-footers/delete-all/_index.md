...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{sectionPath}/headersfooters](https://api.aspose.cloud/v4.0/words/online/delete/{sectionPath}/headersfooters) | PUT |

, where:

* `sectionPath` - the path to the section in the document tree.
...
| `headersFootersTypes` | string | The list of HeaderFooter types.                              |
...
### How to Delete all headers and footers from a Word document using cURL or Postman
...
### How to Delete all headers and footers from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
