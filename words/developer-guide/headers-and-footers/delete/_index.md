...
|--------------------------------|----------------------|--------------|
| https://api.aspose.cloud/v4.0  | [/words/online/delete/{sectionPath}/headersfooters/{index}](https://api.aspose.cloud/v4.0/words/online/delete/{sectionPath}/headersfooters/{index}) | PUT |
...
### How to Delete headers and footers from a Word document using cURL or Postman
...
### How to Delete headers and footers from a Word document using Python, Java, C#, C++, JavaScript and other programming languages
