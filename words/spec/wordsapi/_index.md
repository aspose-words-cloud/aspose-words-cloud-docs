...
- <span style="color:SteelBlue;">object</span> Batch(<span style="color:SteelBlue;">bool</span> ***displayIntermediateResults***, [BatchPartRequest](/words/spec/batch#batchpartrequest)[] ***requests***)</br>- batch request.
