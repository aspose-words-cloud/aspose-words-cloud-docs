...
| PageCount            | <span style="color:SteelBlue;">int</span>     | Gets or sets the number of pages to render. |
| PageIndex            | <span style="color:SteelBlue;">int</span>     | Gets or sets the 0-based index of the first page to render. |
| Compliance           | <span style="color:SteelBlue;">string</span>  | Gets or sets the PDF standards compliance level for output documents. |
...
| CustomPropertiesExport | <span style="color:SteelBlue;">string</span>  | Gets or sets the option that controls the way CustomDocumentProperties are exported to PDF file. The default value is None. |
...
| TextOutputMode       | <span style="color:SteelBlue;">string</span>  | Gets or sets the option that controls how text should be rendered. |
...
| Property             | Type                                          | Description |
|----------------------|-----------------------------------------------|-------------|
| EmfPlusDualRenderingMode | <span style="color:SteelBlue;">string</span>  | Gets or sets the option that controls how EMF+ Dual metafiles should be rendered. |
...
| RenderingMode        | <span style="color:SteelBlue;">string</span>  | Gets or sets the option that controls how metafile images should be rendered. |
...
| HashAlgorithm        | <span style="color:SteelBlue;">string</span>  | Gets or sets the hash algorithm. |
...
| Property             | Type                                          | Description |
|----------------------|-----------------------------------------------|-------------|
| EncryptionAlgorithm  | <span style="color:SteelBlue;">string</span>  | Gets or sets the encryption algorithm to use. |
| OwnerPassword        | <span style="color:SteelBlue;">string</span>  | Gets or sets the owner password for the encrypted PDF document. |
| Permissions          | <span style="color:SteelBlue;">string</span>  | Gets or sets the operations that are allowed to a user on the encrypted PDF document. |
